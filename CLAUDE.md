...
- If the task is vague or equals `__AUTO_NEXT__`, choose exactly one smallest high-value next task and explain the choice in 3 lines or fewer before editing.
...
- If a review script reports that it was skipped for timeout, privacy, auth, or tool-availability reasons, continue and mention that clearly in the final report.
